...
function M.invert(color)
	...
	elseif type(color) == "string" then
		local hsluv = require("raccoon.hsluv")
		if color ~= "NONE" then
...
---@param groups raccoon.Highlights
...
function M.cache.file(key)
	return vim.fn.stdpath("cache") .. "/raccoon" .. ".json"
end

---@param key string
function M.cache.read(key)
	---@type boolean, raccoon.Cache

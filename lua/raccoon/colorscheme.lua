...
local night = require("raccoon.palettes.night")

local colorscheme = {
	standardWhite = "#ffffff",
	standardBlack = "#1e1e1e",
}
print("night crust: ", night.crust)
local themeMode = config.theme or vim.o.background or "dark"
...
if themeMode == "light" then
	...
	colorscheme.editorBackground = "#2a2f38"
	colorscheme.sidebarBackground = "#fafafa"
	colorscheme.popupBackground = "#595f6f"
	colorscheme.floatingWindowBackground = "#595f6f"
	colorscheme.menuOptionBackground = "#c1c1c1"
	...
	colorscheme.windowBorder = "#f5f5f5"
	...
	-- colorscheme.warningText = night.orange
